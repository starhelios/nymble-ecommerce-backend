...
modules = os.listdir(os.path.join("src/modules"))

for folder_name in modules:
    files = os.listdir(os.path.join(f"src/modules/{folder_name}"))
    for file_name in files:
        if file_name == "models.py":
            importlib.import_module(f"src.modules.{folder_name}.models")
